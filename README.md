...
*The details pertaining to these features are mentioned in the [URL Feature Extraction.ipynb.](https://github.com/Swetha-Mamidiga/Phishing-website-detection-using-ML/blob/main/URLFeatureExtraction.py)[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/Swetha-Mamidiga/Phishing-website-detection-using-ML/blob/main/URLFeatureExtraction.py)*
...
All these models are trained on the dataset and evaluation of the model is done with the test dataset. The elaborate details of the models & its training are mentioned in [Phishing Website Detection_Models & Training.ipynb](https://github.com/Swetha-Mamidiga/Phishing-website-detection-using-ML/blob/main/Phishing%20Website%20Detection_Models%20%26%20Training.ipynb)[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/Swetha-Mamidiga/Phishing-website-detection-using-ML/blob/main/Phishing%20Website%20Detection_Models%20%26%20Training.ipynb)
...
https://github.com/Swetha-Mamidiga/Phishing-website-detection-using-ML



 
## End Results
From the obtained results of the above models, XGBoost Classifier has highest model performance of 86.4%. So the model is saved to the file '[XGBoostClassifier.pickle.dat](https://github.com/Swetha-Mamidiga/Phishing-website-detection-using-ML/blob/main/XGBoostClassifier.pickle.dat)'
